...
export const postProject = async (project:Project): Promise<AxiosResponse<{ msg: string, id: string }>> => {
    ...
    return await portfolioApi.post(postProjectEndpoint, project);
};
